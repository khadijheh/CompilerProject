...
public class WebParser extends Parser {
	...
	public static final int
		...
		JINJA_EXPR_OPEN_IN_ATTR=37, JINJA_BLOCK_OPEN_IN_ATTR=38, JINJA_COMMENT_OPEN_IN_ATTR=39, 
		HTML_ATTR_VALUE_CLOSE_DQ=40, HTML_ATTR_VALUE_CLOSE_SQ=41, HTML_ATTR_VALUE_TEXT=42, 
		...
		JINJA_BLOCK_CLOSE=58, JINJA_FOR=59, JINJA_IN=60, JINJA_ENDFOR=61, JINJA_IF=62, 
		JINJA_ELIF=63, JINJA_ELSE=64, JINJA_ENDIF=65, JINJA_SET=66, JINJA_BLOCK_IDENT=67, 
		JINJA_BLOCK_NUMBER=68, JINJA_BLOCK_STRING=69, JINJA_BLOCK_EQ=70, JINJA_BLOCK_DOT=71, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, "'%}'", "'for'", "'in'", "'endfor'", "'if'", "'elif'", "'else'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CSS_COLON", "CSS_VALUE", "CSS_SELECTOR", "CSS_BLOCK_OTHER", "JINJA_EXPR_OPEN_IN_ATTR", 
	...
	public final ForStartContext forStart() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 48)) & ~0x3f) == 0 && ((1L << (_la - 48)) & 3220701185L) != 0)) {
				{
				{
				setState(207);
				jinjaBlockExpr();
		...
		try {
			...
			do {
				...
				case 1:
					...
					setState(254);
					_la = _input.LA(1);
					if ( !(((((_la - 48)) & ~0x3f) == 0 && ((1L << (_la - 48)) & 3220701185L) != 0)) ) {
					_errHandler.recoverInline(this);
					}
					else {
						if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
