...
public class PythonFlaskParser extends Parser {
	...
	public static final int
		RULE_file_input = 0, RULE_decorated_def = 1, RULE_decorator = 2, RULE_decoratorArgs = 3, 
		RULE_namedDecoratorArgs = 4, RULE_stmt = 5, RULE_simple_stmt = 6, RULE_small_stmt = 7, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"file_input", "decorated_def", "decorator", "decoratorArgs", "namedDecoratorArgs", 
	...
	public final File_inputContext file_input() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 15765900267278216L) != 0)) {
				{
				setState(95);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final Decorated_defContext decorated_def() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_decorated_def);
		int _la;
		try {
	...
	public final NamedDecoratorArgsContext namedDecoratorArgs() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_namedDecoratorArgs);
		int _la;
		try {
